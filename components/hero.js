        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              Temukan berbagai informasi seputar anime dari berbagai Musim dan Waktu dalam satu tempat, dan temui para pecinta anime lainnya di Forum Kami!
            </p>
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              ...
              <a
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="w-5 h-5" viewBox="0 0 24 24">
  <title>YouTube</title>
  <path d="M22.4 6.6s-.2-1.7-.8-2.4c-.7-.7-1.4-.8-2.2-.9C17.6 3 12 3 12 3s-5.6 0-7.4.3c-.8.1-1.5.2-2.2.9-.6.7-.8 2.4-.8 2.4S2 8 2 9.6v4.8s.2 1.7.8 2.4c.7.7 1.4.8 2.2.9C6.4 21 12 21 12 21s5.6 0 7.4-.3c.8-.1 1.5-.2 2.2-.9.6-.7.8-2.4.8-2.4s.2-1.7.2-3.5v-1.4s-.2-1.8-.8-2.5zm-14.4 9V8l8 4-8 4z"/>
</svg>
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Di subscribe lebih dari <span className="text-indigo-600">10000+</span>{" "}
            Pengguna Youtube
          </div>
